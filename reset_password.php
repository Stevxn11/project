...
if (!empty($_POST)) {
  ...
  if (esNulo([$user_id,$token, $password, $reepassword])) {
  ...
  if (count($errors) == 0) {
    ...
    if(actualizaPassword($user_id, $pass_hash, $con)){
      ...
      $errors [] = "Error al modificar la contraseña. Intentao de nuevo";
    }
...
<body>
  ...
  <main class="form-login m-auto pt-4">
     ...
     <div class="form-floating">
      ...
      placeholder= "Nueva contraseña" require_once>
       <label for="email"> Nueva contraseña</label>

     </div>

     <div class="form-floating">
      <input class="form-control" type="password" name="reepassword" id="reepassword" 
      placeholder= "Confrimar contraseña" require_once>
       <label for="email">Confrimar contraseña</label>
